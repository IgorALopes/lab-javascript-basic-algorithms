...
let saveIndex = 0
    for (let i = 0; i < text.length; i++) {
        if (text.toLowerCase().slice(saveIndex, text.length).includes("aliquam")) {
            saveIndex += i
            count += 1
        }
    }
...
if (reversePhrase.toUpperCase() === finalPhrase.toUpperCase()) {
    console.log("It's a palindrome")
} else {
    console.log("It's not a palindrome")
}

console.log(reversePhrase, finalPhrase)
